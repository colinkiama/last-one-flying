...
import { JOYSTICK_BASE_RADIUS, JOYSTICK_OFFSET_X, JOYSTICK_OFFSET_Y, JOYSTICK_RADIUS, JOYSTICK_THUMB_RADIUS } from '../constants/touch.js';
...
export class Battle extends Scene {
    ...
    create() {
        ...
        this._touchControlsSystem = new TouchControlsSystem(leftJoystick, rightJoystick);
