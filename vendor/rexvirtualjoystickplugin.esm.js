...
class VectorToCursorKeys extends CursorKeys {
    ...
    get angle() {
        return PhaserMath.RadToDeg(this.rotation); // -180 ~ 180
    }
...
export class VirtualJoyStickPlugin extends Plugins.BasePlugin {
...
function AngleToDirections (angle, dirMode, out) {
    if (out === undefined) {
        out = {};
    } else if (out === true) {
        out = globOut;
