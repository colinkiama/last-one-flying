...
console.log(`Creating ${ouptutFilename} from files in ${OUTPUT_DIRECTORY_NAME} ...`);
...
const archiveFinishPromise = new Promise((resolve) => {
    output.on("finish", () => { 
        console.log(`Finished adding all files from ${OUTPUT_DIRECTORY_NAME} to .zip archive file.`);
